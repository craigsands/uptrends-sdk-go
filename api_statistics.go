 ...
 * @param optional nil or *StatisticsGetMonitorGroupStatisticsOpts - Optional Parameters:
 ...
 * @param optional nil or *StatisticsGetMonitorStatisticsOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  The filter for the requested response fields. E.g. \&quot;Alerts,SlaTarget\&quot;.
     * @param "Start" (optional.Time) -  The start of a custom period (can&#39;t be used together with the PresetPeriod parameter)
     * @param "End" (optional.Time) -  The end of a custom period
     * @param "PresetPeriod" (optional.String) -  The requested time period.
